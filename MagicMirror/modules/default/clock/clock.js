...
Module.register("clock",{
	...
	getDom: function() {
		...
		// Style Wrappers
		dateWrapper.setAttribute("id", "date");
		...
		if (this.config.clockBold === true) {
			timeString = "<div id='time' style='display:inline'>" + now.format(hourSymbol + "[<span class=\"bold\">]mm[</span>]");
		} else {
			timeString = "<div id='time' style='display:inline'>" + now.format(hourSymbol + ":mm");
		}
		...
		timeWrapper.innerHTML = timeString + "</div>";

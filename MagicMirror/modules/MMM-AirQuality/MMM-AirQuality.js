	...
	getDom: function() {
		...
		wrapper.innerHTML = 
			this.html.quality.format(
				this.html.icon,
				'<div id=impact style="display:inline">'+this.data.impact+'</div>',
				(this.config.showIndex?'(<div id=dust style="display:inline">'+this.data.value+'</div>)':''))+

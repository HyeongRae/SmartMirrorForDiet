Module.register("MMM-Voice-Commands", {
	...
	/*defaults: {
		...
		activateCommand: "미러", //Command to active all other commands
	...
	start: function() {
		...
		this.activateCommand = this.config.activate러Command;
	...
	initAnnyang: function(){
		...
		if (annyang) {
			...
			if(self.test){
				annyang.addCAlllback('result', function(e){
					console.log(e);
				})				
			}
		}
